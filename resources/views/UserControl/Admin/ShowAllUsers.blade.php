...
<div id="taskmanger" class="col-lg-12">
    <div class="card">
        ...
        <div class="card-header d-flex align-items-center">
            <h3 class="h4 whitefont  ">Show All Users</h3>
        </div>
            ...
            <table class="table  table-responsive-md table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Projects Count Active</th>
                        <th scope="col">Projects Count Finished</th>
                ...
                <tbody>
                    <span>
                        <tr v-for="user in users" :key="user.id">
                            ...
                            <td> @{{user.projects | GetCountProjectActive}}</td>
                            <td> @{{user.projects | GetCountProjectFinish}}</td>
                            <td>
