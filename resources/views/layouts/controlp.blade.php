<!DOCTYPE html>
<!–– This Code was written By mgi.x.mgi@gmail.com
  you need information ,send msg ! ––>
...
<!-- theme stylesheet-->
<link rel="stylesheet" href="/css/style.Controll.css"
	id="theme-stylesheet">
					...
					<div
						...
						<div class="navbar-header">
							...
							<a href="index.html" class="navbar-brand">
								<div class="brand-text brand-big">
									<span> @lang("Control.Nameincontrolone") </span><strong>@lang('Control.Nameincontroltow')</strong>
								</div>
						...
						<ul
							...
							<li class="nav-item d-flex align-items-center"><a id="search"
								href="#"><i class="icon-search"></i></a></li>
							<!-- Notifications-->
		...
		<div class="page-content d-flex align-items-stretch">
			...
			<nav id='side-navbar11' class="side-navbar">
				...
				<div class="sidebar-header d-flex align-items-center">
					<div class="avatar">
						<img src="/img/avatar-{{rand(1, 6)}}.jpg" alt="..."
							class="img-fluid rounded-circle">
					</div>
					<div class="title">
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-sm-6 text-right">
								<p>
									Design by <a href=""
										class="external">Me ,Ver 2.0 Beta</a>
								</p>
